...
public class DriverRegistration extends AppCompatActivity {
    ...
    protected void getData() {
        ...
        Firebase userReference = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Users");
    ...
    private void createAccount(String mail, String pass) {
        final Firebase myFirebaseRef = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Users");
