...
public class iLink {
    private static String usersNode = "https://smartparkingsystem-6187e.firebaseio.com/Users/";
    private static String parkingLot = "https://smartparkingsystem-6187e.firebaseio.com/ParkingLot/";
    ...
    public static void checkout(final String spot, final long startTime) {
        ...
        Firebase parkingLotLink = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/ParkingLot/" + spot);
    ...
    protected static int[] getParkingLotStatus(final long startTime, final long endTime) {
        ...
        Firebase parkingLotLink = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/ParkingLot");
    ...
    protected static void getUserReservationStatus() {
        ...
        String ref = "https://smartparkingsystem-6187e.firebaseio.com/Users/" + userName + "/ReservationStatus";
    ...
    protected static void updateUserActivity() {
        Firebase parkingLotLink = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Users");
        parkingLotLink.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            @Override
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
    ...
    private static void updateUserReservationStatus(final String userName, String spot, long startTime, long endTime) {
        ...
        Firebase parkingLotLink = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/ParkingLot/SpotDefaultPrice");
        parkingLotLink.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            @Override
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
    ...
    protected static HashMap<String, String> getChildInfo(String root, final String child) {
        ...
        String ref = "https://smartparkingsystem-6187e.firebaseio.com/" + root +
                "/" + child;
        Firebase fReference = new Firebase(ref);
    ...
    protected static double getDefaultPrice() {
        String ref = "https://smartparkingsystem-6187e.firebaseio.com/ParkingLot/SpotDefaultPrice/Price";
        Firebase fReference = new Firebase(ref);
