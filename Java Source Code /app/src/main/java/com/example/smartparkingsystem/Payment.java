...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Users/" + userName);
        ...
        currPrice.setText("Current rate is: " + "R" + currentPrice + "/hour");
        ...
        totalPayText.setText(String.format("R%.2f", totPay));
