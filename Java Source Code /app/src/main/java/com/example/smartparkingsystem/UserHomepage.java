...
public class UserHomepage extends AppCompatActivity {
    ...
    public UserHomepage (Context context, HashMap<String, String> infoMap){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase userReservationDB = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Users/" + userName + "/ReservationStatus");
