...
public class Messages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase resetRead = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Users/" + userName +"/ReservationStatus/NewMessages");
        resetRead.setValue(false);
        ListView messages = (ListView) findViewById(R.id.list_view_messages);
        root = new Firebase("https://smartparkingsystem-6187e.firebaseio.com/Messages");
