...
public class Emergency extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        root = new Firebase("https://smartparkingsystem-6187e.firebaseio.com");
        ...
        helpButt.setOnClickListener(new View.OnClickListener() {
            ...
            // Set the corresponding parking lot to red
            //TO DO

            //Then add this to log history
            //TO DO

            //Then pop out a window indicating successful report
            @Override
            public void onClick(View v) {
